...
public class ProductService {
    ...
    public ResponseEntity<ProductModel> createProduct(ProductForCreationDTO newProduct){
        return ResponseEntity.ok(productDao.createProduct(new ProductModel(newProduct.getProductName(), newProduct.getDescription(), newProduct.getCategory(),newProduct.getPrice())));
    }
